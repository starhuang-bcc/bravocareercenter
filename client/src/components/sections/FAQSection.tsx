...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "我們從軟體產業出發，多年來累積了豐富的人才招募實戰經驗。但我們從未停下腳步——持續參與各產業論壇與展覽，也積極深耕 LinkedIn 等專業社群，認識各行各業優秀的專業人士，逐步建立起涵蓋多元產業的人才資料庫。\n\n現在的我們，對各類職缺的招募需求都有十足的信心與準備。無論是常見職位還是特殊需求，都歡迎與我們聊聊。",
  },
];
